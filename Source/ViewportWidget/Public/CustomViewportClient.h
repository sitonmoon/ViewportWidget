...
class VIEWPORTWIDGET_API FCustomUMGViewportClient : public FUMGViewportClient
{
public:
	FCustomUMGViewportClient(FPreviewScene* InPreviewScene = nullptr);
	virtual ~FCustomUMGViewportClient();

	void SetViewFOV(const float InFOV) { 
		ViewInfo.FOV = InFOV;
	};
};
...
{
public:
	FCustomViewportClient(FPreviewScene* InPreviewScene = nullptr, const TWeakPtr<SViewportWidget>& InCustomViewportWidget = nullptr);
